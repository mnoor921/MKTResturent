		...
		<div class="card-box pb-10">
			...
			<table class="data-table table nowrap">
				...
				<tbody>
					<?php 
					$isdel = 0;
					$query = $connect->prepare("SELECT * FROM orders where isdel=? order by order_id desc");
					$query->bind_param("s",$isdel);
					$query->execute();
						...
						<tr>
							...
							<td>
								<div class="table-actions">
									<a href="order-detail.php?id=<?=$query_fetch['order_id']?>" data-color="#265ed7"><i class="icon-copy dw dw-edit2"></i></a>
