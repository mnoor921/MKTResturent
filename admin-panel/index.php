...
$query = mysqli_query($connect,"SELECT * FROM orders WHERE time BETWEEN  '".$start."'  AND '".$end."'");
$total_orders = mysqli_num_rows($query);

$p_query = mysqli_query($connect,"SELECT * FROM product");
$total_products = mysqli_num_rows($p_query);

$t_query = mysqli_query($connect,"SELECT * FROM team");
$total_team = mysqli_num_rows($t_query);
...
<div class="main-container">
	<div class="xs-pd-20-10 pd-ltr-20">
		...
		<div class="title pb-20">
			<h2 class="h3 mb-0">Well Come Dashboard</h2>
		</div>
		...
		<div class="row pb-10">
				...
				<div class="card-box height-100-p widget-style3">
					<div class="d-flex flex-wrap">
						<div class="widget-data">
							...
							<div class="font-14 text-secondary weight-500">Today Order</div>
						</div>
			...
			<div class="col-xl-4 col-lg-4 col-md-6 mb-20">
				<div class="card-box height-100-p widget-style3">
					<div class="d-flex flex-wrap">
						<div class="widget-data">
							<div class="weight-700 font-24 text-dark"><?=@$total_team?></div>
							<div class="font-14 text-secondary weight-500">Total Team</div>
						</div>
						<div class="widget-icon">
		...
		<div class="text-center mt-5">
			<img src="../img/imgpsh_fullsize_anim.png" width="300px" alt="">
		</div>
